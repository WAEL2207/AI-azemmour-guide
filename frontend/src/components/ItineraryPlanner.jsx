  ...
  return (
    <div>
      <div className="itinerary-controls">
        <p className="itinerary-controls__label">Choisis les types de lieux a visiter a Azemmour</p>
        ...
        <button className="btn" onClick={generer} disabled={selected.size === 0 || loading}>
          {loading ? "Calcul en cours…" : "✨ Generer l'itineraire"}
        </button>
      </div>
        ...
        <>
          <div className="itinerary-summary">
            <div className="summary-figure" style={{ "--figure-color": "var(--color-terracotta)" }}>
              ...
              <div className="summary-figure__label">Lieux</div>
            </div>
            <div className="summary-figure" style={{ "--figure-color": "var(--color-teal)" }}>
              ...
              <div className="summary-figure__label">Temps de visite</div>
            </div>
            <div className="summary-figure" style={{ "--figure-color": "var(--color-gold)" }}>
              ...
              <div className="summary-figure__label">Temps de trajet</div>
            </div>
            <div className="summary-figure" style={{ "--figure-color": "var(--color-terracotta-deep)" }}>
              ...
              <div className="summary-figure__label">Duree totale</div>
            </div>
          </div>

          <div className="route">
            {result.etapes.map((etape, i) => {
              const meta = categoryMeta(etape.categorie);
              const isLast = i === result.etapes.length - 1;
              return (
                <div key={etape.id}>
                  {i > 0 && (
                    <p className="route-travel-note">
                      → {etape.trajet_depuis_precedent_km} km · {etape.trajet_depuis_precedent_min} min de trajet
                    </p>
                  )}
                    ...
                    <div className="route-stop__content">
                      ...
                      <div className="route-stop__text">
                        ...
                        <div className="route-stop__meta">
                          ...
                          <span>~{etape.duree_visite_min} min de visite</span>
                        </div>
                      </div>
                    </div>
                  </div>
